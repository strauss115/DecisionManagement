...
app.config(['$routeProvider', function ($routeProvider) {
        $routeProvider
                // Home
                .when("/", {templateUrl: "pages/home.html", controller: "Home"})
                .when("/home", {templateUrl: "pages/home.html", controller: "Home"})
                // Pages
                .when("/createDecision", {templateUrl: "pages/createDecision.html", controller: "CreateDecision"})
                .when("/editDecision", {templateUrl: "pages/editDecision.html", controller: "PageCtrl"})
                .when("/completeDecision", {templateUrl: "pages/completeDecision.html", controller: "PageCtrl"})
                .when("/relateDecision", {templateUrl: "pages/relateDecision.html", controller: "PageCtrl"})
                .when("/timeline", {templateUrl: "pages/timeline.html", controller: "PageCtrl"})
                .when("/showDependency", {templateUrl: "pages/showDependency.html", controller: "PageCtrl"})
                .when("/showGroup", {templateUrl: "pages/showGroup.html", controller: "PageCtrl"})
                .when("/showCriteria", {templateUrl: "pages/showCriteria.html", controller: "PageCtrl"})


                .otherwise("/home", {templateUrl: "pages/home.html", controller: "Home"});
    }]);
/**
 * Home Controller
 */
...
/**
 * CreateDecision Controller
 */
app.controller('CreateDecision', [])
        .directive('goDiagram', function () {
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    var myDiagram = $(go.Diagram, "myDiagram1",
                            {
                    ...
                    function addNodeAndLink(e, obj) {
                        ...
                        var olddata = oldnode.data; // copy the brush and direction to the new node data
                    ...
                    function layoutAll() {
                        ...
                        root.findLinksConnected().each(function (link) {
                            ...
                            if (child.data.dir === "left") {
                                ...
                                rightward.add(root); // the root node is in both collections                 rightward.add(link);
        ...
        .controller('MinimalCtrl', function ($scope) {
            $scope.model = new go.GraphLinksModel(
                    [
                        ...
                        {"key": 1, "parent": 0, "text": "Gruppe", "brush": "skyblue", "dir": "right", "loc": "77 -22"},
                        {"key": 11, "parent": 1, "text": "Architekturentscheidung", "brush": "skyblue", "dir": "right", "loc": "200 -48"},
                        {"key": 2, "parent": 0, "text": "Lösungsalternative", "brush": "darkseagreen", "dir": "right", "loc": "77 43"},
                        {"key": 21, "parent": 2, "text": "Fat-Client", "brush": "darkseagreen", "dir": "right", "loc": "203 30"},
