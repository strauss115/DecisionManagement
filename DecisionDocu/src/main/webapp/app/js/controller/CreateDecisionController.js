/**
 * Controller for the 'createDecision.html' - create decisions and add
 * attributes
 */
app
		.controller(
				...
				[
						...
						function($scope, $cookies, CreateDecision,
								AddAttributeToDecision) {
							...
							// method to create initial decision
									...
									$scope.model = new go.Model.fromJson(
											{
												...
												"nodeDataArray" : [
														...
														},
														{
															...
															"brush" : "skyblue",
															"dir" : "right",
															"loc" : ($scope.decisionName.length * 7)
																	+ " -50",
															showAdd : true,
															editable : false
														},
